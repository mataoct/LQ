...
NSString *const MJEnterpriceCollectionViewCellIdentifier = @"EnterpriceCollectionViewCell";

@interface MenuForEnterpriceController ()
...
@implementation MenuForEnterpriceController
...
- (void)viewDidLoad
{
    ...
    layout.itemSize = CGSizeMake(145, 230);
    layout.sectionInset = UIEdgeInsetsMake(10, 10, 10, 10);
    layout.minimumInteritemSpacing = 10;
    layout.minimumLineSpacing = 10;
    
    _menuTable = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 40, 320, self.view.frame.size.height-64 -40 - 50) collectionViewLayout:layout];
    ...
    UINib *nib = [UINib nibWithNibName:@"EnterpriceCollectionViewCell"
                                bundle: [NSBundle mainBundle]];
    //    [_collectionView registerClass:[UICollectionViewCell class] forCellWithReuseIdentifier:MJCollectionViewCellIdentifier];
    
    [_menuTable registerNib:nib forCellWithReuseIdentifier:MJEnterpriceCollectionViewCellIdentifier];
...
//    WaterFlowModel  *object = [_sourceArr objectAtIndex:indexPath.row];
    ...
    EnterpriceCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:MJEnterpriceCollectionViewCellIdentifier forIndexPath:indexPath];

...
- (void)viewDidLoad
{
    ...
    [_registBtn setTitle:@"重置密码" forState:UIControlStateNormal];
    ...
    switch (model.ResponseTag) {
        ...
        case 10002:
        {
            [self dismissViewControllerAnimated:YES completion:^{
                [SVProgressHUD showSuccessWithStatus_custom:@"重置密码成功" duration:1.5];
            }];

...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _activityViewLoad.frame = CGRectMake(CGRectGetWidth(self.frame)/2, CGRectGetHeight(self.frame)/2, 20, 20);
        _activityViewLoad.center = CGPointMake(CGRectGetWidth(self.frame)/2, CGRectGetHeight(self.frame)/2);
        [self addSubview:_activityViewLoad];
//        [_activityViewLoad release];
...
- (void)reloadData{
    ...
    if (_activityViewLoad) {
        
        [_activityViewLoad stopAnimating];
        [_activityViewLoad removeFromSuperview];
